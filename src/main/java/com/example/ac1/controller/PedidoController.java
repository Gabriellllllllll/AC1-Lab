...
public class PedidoController {
    ...
    public ResponseEntity<Pedido> getPedido(@PathVariable final int codigo){
        final Pedido pedido = repository.getPedidoByCodigo(codigo);
        if(pedido != null){
    ...
    public ResponseEntity<Void> remover(@PathVariable final int codigo){
        final Pedido pedido = repository.getPedidoByCodigo(codigo);
        if(pedido != null){
    ...
    @PutMapping("/{codigo}")
    public ResponseEntity<Pedido> atualizar(@PathVariable final int codigo, @RequestBody Pedido pedido){
